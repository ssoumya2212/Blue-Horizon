  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="p-5 flex flex-col justify-between shadow-[var(--shadow-card)]">
          <div className="flex items-center justify-between mb-2">
            <h3 className="font-semibold text-muted-foreground">Fleet Eco-Score</h3>
            <div className="p-2 bg-success/10 text-success rounded-lg">
              <Leaf className="h-5 w-5" />
            </div>
          </div>
          <p className="text-4xl font-bold">92<span className="text-lg text-muted-foreground">/100</span></p>
        ...
        <Card className="p-5 flex flex-col justify-between shadow-[var(--shadow-card)]">
          <div className="flex items-center justify-between mb-2">
            <h3 className="font-semibold text-muted-foreground">On-Time Performance</h3>
        ...
        <Card className="p-5 flex flex-col justify-between shadow-[var(--shadow-card)]">
          <div className="flex items-center justify-between mb-2">
            <h3 className="font-semibold text-muted-foreground">Risk Anomalies</h3>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="p-5">
          <h2 className="text-lg font-semibold mb-4">On-Time Performance by Route</h2>
          <div className="h-[250px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={otpData}>
                ...
                <Bar dataKey="onTime" name="On Time (%)" fill="hsl(var(--success))" radius={[4, 4, 0, 0]} />
                <Bar dataKey="delayed" name="Delayed (%)" fill="hsl(var(--destructive))" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </Card>
