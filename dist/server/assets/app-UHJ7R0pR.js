import { O as useRouter, r as reactExports, W as jsxRuntimeExports, a1 as Outlet } from "./server-istEu6hz.js";
import { c as createLucideIcon, u as useNavigate, a as Logo, L as Link, N as Navigate, g as getPassengers } from "./router-BsyVVfp8.js";
import { c as createSlot$1, u as useComposedRefs, S as Slot$1, B as Button, a as composeRefs } from "./button-CavBh9lM.js";
import { c as cva } from "./index-BNcWPUAp.js";
import { c as cn } from "./utils-BH6shBk-.js";
import { I as Input } from "./input-CRWvdhoz.js";
import { R as Root$3, P as Portal$2, C as Content, a as Close, X, T as Title, D as Description, O as Overlay, b as Portal$3, c as DismissableLayer, h as hideOthers, d as ReactRemoveScroll, u as useFocusGuards, F as FocusScope } from "./index-CCEVeydi.js";
import { P as Primitive$1, u as useControllableState, c as composeEventHandlers, a as createContextScope } from "./index-C1Q8V0C-.js";
import { u as useId, P as Presence } from "./index-CT11DaeY.js";
import { R as Root2$1, A as Anchor, c as createPopperScope, C as Content$1, a as Arrow, F as FileText, r as registerPlugin, S as Search } from "./index-C52yNxLP.js";
import { a as signOut, g as getSession } from "./auth-ILkY_i2v.js";
import { R as Route } from "./route-DzPNR4tc.js";
import { B as Bell } from "./bell-sE2qZ6ck.js";
import { S as Settings, f as formatDistanceToNow } from "./formatDistanceToNow-CkCwV2Ww.js";
...
import { u as useCallbackRef } from "./index-DrzusK0R.js";
import { u as useDirection } from "./index-Q0VUDqDg.js";
import { u as useLayoutEffect2 } from "./index-CrY51Zax.js";
import { f as fetchNotifications, s as subscribeToNotifications, m as markAsRead } from "./notifications-BHQnheDj.js";
...
import { A as Avatar, a as AvatarFallback } from "./avatar-C1ZweDmP.js";
import { u as useSearchQuery, s as setSearchQuery } from "./search-C5CAsgh8.js";
import "node:async_hooks";
import "node:stream/web";
import "node:stream";
import "./index-Csqdc9BX.js";
  ...
  admin: [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Routes", url: "/app/routes", icon: Route }
      ]
    },
    {
      label: "System",
  ...
  driver: [
    {
      ...
      items: [
        ...
        { title: "Stops & Route", url: "/app/routes", icon: Route },
        { title: "Notifications", url: "/app/notifications", icon: Bell },
...
function AppSidebar({ role }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Sidebar, { collapsible: "icon", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarHeader, { className: "border-b border-sidebar-border p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, { variant: "light" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarContent, { children: groups.map((g) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroup, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: g.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuButton, { asChild: true, isActive: pathname === item.url, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: item.url, className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { className: "h-4 w-4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item.title })
      ] }) }) }, item.title)) }) })
    ] }, g.label)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarFooter, { className: "border-t border-sidebar-border p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      SidebarMenuButton,
      {
        onClick: () => {
          signOut();
...
const LocalNotifications = registerPlugin("LocalNotifications", {
  web: () => import("./web-DNjeS4V1.js").then((m) => new m.LocalNotificationsWeb())
});
// @__NO_SIDE_EFFECTS__
...
function NotificationsDropdown({ role }) {
  ...
  reactExports.useEffect(() => {
    ...
    const subscription = subscribeToNotifications(role, (payload) => {
      if (payload.eventType === "INSERT") {
        ...
        setNotifications(
          (prev) => prev.map((n) => n.id === payload.new.id ? payload.new : n)
        );
      }
    });
    return () => {
  ...
  const getIcon = (type) => {
    switch (type) {
      case "bus_arrival":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-4 w-4 text-blue-500" });
      case "bus_delay":
      case "delay":
      ...
      case "gps_update":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-4 w-4 text-emerald-500" });
      case "attendance":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-4 w-4 text-green-500" });
      case "announcement":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { className: "h-4 w-4 text-purple-500" });
      case "route_update":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { className: "h-4 w-4 text-indigo-500" });
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Info, { className: "h-4 w-4 text-primary" });
    }
  };
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        ...
        children: [
          ...
          unreadCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute right-2 top-2 flex h-2 w-2 rounded-full bg-destructive shadow-[0_0_0_2px_var(--background)]" })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      PopoverContent,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b px-4 py-3 bg-muted/20", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "max-h-[400px]", children: notifications.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center p-8 text-sm text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3 rounded-full bg-muted p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "h-6 w-6 opacity-40" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No new notifications" })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y", children: notifications.map((notification) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-0.5 shrink-0 rounded-full border bg-background p-2 shadow-sm", children: getIcon(notification.type) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-snug", children: notification.message }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-medium text-muted-foreground pt-1", children: formatDistanceToNow(new Date(notification.created_at), {
                    addSuffix: true
                  }) })
                ] }),
                !notification.read && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1.5 h-2 w-2 shrink-0 rounded-full bg-primary" })
              ]
            },
            notification.id
          )) }) })
...
function TopNavbar({ session }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-30 flex h-16 items-center gap-3 border-b bg-card/80 px-4 backdrop-blur md:px-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(NotificationsDropdown, { role: session.role }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 rounded-full bg-muted/50 py-1 pl-1 pr-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "h-8 w-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "bg-primary text-primary-foreground text-xs", children: initials }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden text-left sm:block", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium leading-tight", children: session.username }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] capitalize text-muted-foreground leading-tight", children: session.role })
        ] })
      ] })
    ] })
  ] });
...
function AppLayout() {
  ...
  if (!loaded) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background" });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen w-full bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AppSidebar, { role: session.role }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarInset, { className: "flex flex-1 flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TopNavbar, { session }),
