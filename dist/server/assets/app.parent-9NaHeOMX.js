...
import { L as LoadScript, G as GoogleMap, M as Marker } from "./esm-C2Lp6Yo7.js";
import { u as useFleetPositions } from "./tracking-Io9upiU-.js";
import { c as createLucideIcon, e as supabase, G as GraduationCap } from "./router-6xa8Ve6B.js";
import { t as toast } from "./index-gz2JDtlF.js";
import { s as subscribeToNotifications, f as fetchNotifications, a as addNotification } from "./notifications-BMG8igOt.js";
import { M as MapPin } from "./map-pin-9qI4ZE2z.js";
import { C as Clock } from "./clock-KV_OY1j9.js";
import { f as formatDistanceToNow, S as Settings } from "./formatDistanceToNow-Cf92aYxq.js";
import { P as Phone } from "./phone-BttuFrv3.js";
import { M as MessageSquare } from "./message-square-ziAEoYw_.js";
...
function ParentDashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 sm:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", className: "h-14 justify-start gap-3 border-primary/20 bg-primary/5 hover:bg-primary/10 text-primary", onClick: () => {
...
function MessagesBoard() {
  ...
  const handleSend = async (e) => {
    ...
    setLoading(true);
    await addNotification("Message from Parent (Aarav S)", msgInput, "announcement", "all");
